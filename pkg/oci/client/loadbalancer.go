...
type LoadBalancerInterface interface {
	...
	CreateRoutingPolicy(ctx context.Context, lbID string, details loadbalancer.CreateRoutingPolicyDetails) (string, error)
	UpdateRoutingPolicy(ctx context.Context, lbID string, name string, details loadbalancer.UpdateRoutingPolicyDetails) (string, error)
	DeleteRoutingPolicy(ctx context.Context, lbID string, name string) (string, error)

	CreateRuleSet(ctx context.Context, lbID string, details loadbalancer.CreateRuleSetDetails) (string, error)
	UpdateRuleSet(ctx context.Context, lbID string, name string, details loadbalancer.UpdateRuleSetDetails) (string, error)
	DeleteRuleSet(ctx context.Context, lbID string, name string) (string, error)

	CreateHostname(ctx context.Context, lbID string, details loadbalancer.HostnameDetails) (string, error)
	DeleteHostname(ctx context.Context, lbID string, name string) (string, error)

	DeleteCertificate(ctx context.Context, lbID string, name string) (string, error)
}
